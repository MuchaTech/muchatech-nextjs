        ...
        <div className="w-full max-w-sm">
          ...
          <div className="flex justify-center mb-8">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(43,233,240,0.10), rgba(252,33,209,0.08))",
          ...
          >
            ...
            {error && (
              <div
                ...
                style={{
                  backgroundColor: isLocked
                    ? "rgba(252,33,209,0.06)"
                    : "rgba(252,33,209,0.05)",
              ...
              >
                ...
                />
                <div>
                  <p className="font-mono text-xs" style={{ color: "#FC21D1" }}>
                    {error}
                  </p>
              ...
              <div className="flex items-center justify-center gap-1.5 mt-5">
                {Array.from({ length: MAX_ATTEMPTS }).map((_, i) => (
                  <span
                    ...
                    style={{
                      backgroundColor:
                        i < attempts ? "#FC21D1" : "var(--border-b)",
                    }}
                  />
                ))}
              </div>
